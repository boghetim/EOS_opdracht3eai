...
# xsct D:\Embedded_Systemen\HW_EOS\eind2\design_1_wrapper\platform.tcl
# 
# OR launch xsct and run below command.
# source D:\Embedded_Systemen\HW_EOS\eind2\design_1_wrapper\platform.tcl
# 
# To create the platform in a different location, modify the -out option of "platform create" command.
# -out option specifies the output directory of the platform project.

platform create -name {design_1_wrapper}\
-hw {D:\EOS_opdracht3eai\vraag2\vitis_udp_server\design_1_wrapper.xsa}\
